/**
 * ARCHIVED — Automated appointment management flow preserved for future reactivation.
 * Not connected to any public route.
 */
"use client";
...
export default function CitaAutomatedFlow() {
  return (
